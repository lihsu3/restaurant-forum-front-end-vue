  ...
  <div class="album py-5 bg-light">
    <div class="container">
      <UserProfileCard 
        ...
        :num-of-commented-restaurants="numOfCommentedRestaurants"
        :num-of-favorited-restaurants="numOfFavoritedRestaurants"
        :num-of-followings="numOfFollowings"
        :num-of-followers="numOfFollowers"
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <UserCommentsCard 
            :commented-restaurants="commentedRestaurants"
          />
          <br>
...
export default {
  ...
  data () {
    return {
      ...
      numOfFollowings: -1,
      followings: {},
      numOfFavoritedRestaurants: -1,
      favoritedRestaurants: {},
      isFollowed: false,
      numOfCommentedRestaurants: -1,
  ...
  methods: {
    fetchUser (userId) {
      ...
      // a list of commented restaurants without duplication
      const listUniqueRestaurant = dummyData.profile.Comments.map((comment) => {
        return {
          id: comment.Restaurant.id,
          image: comment.Restaurant.image 
        }
      }).filter((restaurant, idx, self) => 
        idx === self.findIndex((r) => r.id === restaurant.id)
      )
      ...
      this.numOfFollowers = dummyData.profile.Followers.length
      this.followers = {
        numOfFollowers: dummyData.profile.Followers.length,
        profiles: dummyData.profile.Followers
      }
      this.numOfFollowings = dummyData.profile.Followings.length
      this.followings = {
        numOfFollowings: dummyData.profile.Followings.length,
        profiles: dummyData.profile.Followings
      }
      this.numOfFavoritedRestaurants = dummyData.profile.FavoritedRestaurants.length
      this.favoritedRestaurants = {
        numOfFavoritedRestaurants: dummyData.profile.FavoritedRestaurants.length,
        restaurants: dummyData.profile.FavoritedRestaurants
      }
      this.isFollowed = dummyData.isFollowed
      this.numOfCommentedRestaurants = listUniqueRestaurant.length
      this.commentedRestaurants = {
        numOfCommentedRestaurants: listUniqueRestaurant.length,
        restaurants: listUniqueRestaurant
      }
    },
  }
}
